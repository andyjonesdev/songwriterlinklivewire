<div class="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
    <div class="relative flex-1 rounded-xl border border-sidebar-border/70 dark:border-sidebar-border p-6">
        ...
        <p class="text-sm text-gray-500 mb-6">Lyrics sharing the same title. The oldest entry is listed first.</p>
        ...
        @else
            ...
            @foreach ($groups as $group)
                <div class="mb-8 rounded-lg border border-red-200 bg-red-50 p-4">
                    <h2 class="text-lg font-semibold mb-3 text-red-800">{{ $group->first()->title }}
