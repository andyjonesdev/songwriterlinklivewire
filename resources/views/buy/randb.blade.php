<x-layouts.page :title="__('Buy R&B Song Lyrics | Original R&B Lyrics for Sale - SongwriterLink')" 
:description="__('Browse original R&B song lyrics written by independent lyricists. License soulful, emotional R&B lyrics for your next release — affordable, legal, and ready to record.')"
    ...
    <div class="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
        <main class="flex w-full flex-col-reverse overflow-hidden rounded-lg lg:flex-row">
            <div class="p-6 lg:p-0 flex-1 rounded-lg pb-12 text-[13px] leading-[20px] bg-[#ffffff78] bg-gray-50 lg:p-20">
                <h1 class="mb-1 font-medium text-4xl lg:text-6xl">Buy R&B Song Lyrics</h1>
            </div>  
        </main>
    </div>

    <div class="lg:w-2/3 lg:mx-20">         
        <h2 class="text-2xl mt-8 mb-4">Looking for soulful R&B lyrics with emotion and groove?</h2>

        <p>
            R&B lyrics focus on feeling, melody, and connection. At SongwriterLink, you can explore original R&B song lyrics written by independent lyricists who specialize in love songs, emotional ballads, and smooth, melodic songwriting. Whether you’re creating modern R&B, neo-soul, or classic rhythm and blues, you’ll find lyrics crafted to match the mood and flow of your music.
        </p>

        <h3 class="text-lg mt-8 mb-4"><b>How buying R&B lyrics works</b></h3>
        <ol class="list-decimal ml-2 md:flex gap-4">
            <li class="bg-gray-200 mx-2 p-2">Browse R&B lyrics designed for melodic and emotional songs</li>
        ...
        <h3 class="text-lg mt-8 mb-4"><b>Are these R&B lyrics safe to use?</b></h3>
        <p class="my-4">
            Yes. When you purchase lyrics on SongwriterLink, you receive a license from the original lyricist to use those lyrics in your own recordings. This allows you to release, stream, and perform your R&B song according to the license terms shown on each lyric page.
        </p>

        <p class="my-4">
            No generic templates. No copyright risks. Just original R&B lyrics ready for your next song.
        </p>

        <h3 class="text-lg mt-8 mb-4"><b>Why artists buy R&B lyrics here</b></h3>
        <ol class="flex flex-col gap-2">
            <li class="bg-gray-100 p-2 w-fit"><i class="fa-sharp-duotone fa-solid fa-badge-check"></i> Written by real R&B lyricists, not AI generators</li>
            <li class="bg-gray-200 p-2 w-fit"><i class="fa-sharp-duotone fa-solid fa-badge-check"></i> Perfect for R&B, neo-soul, and contemporary soul styles</li>
            <li class="bg-gray-100 p-2 w-fit"><i class="fa-sharp-duotone fa-solid fa-badge-check"></i> More affordable than hiring a dedicated songwriter</li>
        ...
        <h3 class="mt-12 text-xl">
            Browse R&B song lyrics for sale below and find the perfect lyrics for your next R&B release.
        </h3>
    </div>
