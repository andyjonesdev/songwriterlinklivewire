...
:description="__('Browse original country song lyrics written by independent lyricists. License professional country lyrics for your next release — affordable, legal, and ready to use.')">
...
<h2 class="text-2xl mt-8 mb-4">Looking for country lyrics for your next song?</h2>
<p>At SongwriterLink, you can browse and license original country lyrics written by independent lyricists from around the world. Whether you’re an artist, producer, or band, our country lyrics are ready for immediate use — no ghostwriters, no commissions, and no complicated contracts.</p>

<h3 class="text-lg mt-8 mb-4"><b>How buying country lyrics works</b></h3>
<ol class="list-decimal ml-2 md:flex gap-4">
<li class="bg-gray-200 mx-2 p-2">Browse available country song lyrics below</li>
...
<p class="my-4">No guessing. No copyright risks. Just original country lyrics ready for music.</p>

<h3 class="text-lg mt-8 mb-4"><b>Why artists buy country lyrics here</b></h3>
<ol class="flex flex-col gap-2">
<li class="bg-gray-100 p-2 w-fit">✔ Written by real songwriters, not AI</li>
<li class="bg-gray-200 p-2 w-fit">✔ Perfect for country, Americana, folk, and acoustic styles</li>
<li class="bg-gray-100 p-2 w-fit">✔ More affordable than hiring a songwriter</li>
<li class="bg-gray-200 p-2 w-fit">✔ Instant digital delivery</li>
<li class="bg-gray-100 p-2 w-fit">✔ Clear licensing terms with every purchase</li>
</ol>

<h3 class="mt-12 text-xl">Browse country song lyrics for sale below and find the perfect lyrics for your next release.</h3>
...
<div class="gap-4 py-12 justify-around lg:grid grid-cols-3 gap-4 lg:mx-20">
        ...
        <div class="lg:w-2/3 lg:mx-20">
            <button
                onclick="window.location.href='{{ route('buyLyrics', 'genre=Country') }}'"
                class="rounded-sm bg-[#e8363c] px-5 py-1 my-1 text-lg text-white hover:bg-black cursor-pointer mx-auto w-fit"
            >
                <i class="fa-sharp-duotone fa-solid fa-eye"></i> View More Country Lyrics
            </button>
            <hr class="mt-8" />
