<x-layouts.page :title="__('Buy Rap Lyrics | Original Rap Lyrics for Sale - SongwriterLink')" 
:description="__('Browse original rap lyrics written by independent lyricists. License professional rap lyrics for your next release — affordable, legal, and ready to use.')"
...
<p>Rap music lives and dies by the lyrics — the rhythm, the punchlines, the storytelling. On SongwriterLink, you’ll find 
    original rap lyrics written by independent hip-hop lyricists who specialize in verses, hooks, and full song 
    structures designed for modern rap and hip-hop production. Whether you’re working on a trap beat, boom bap 
...
<p class="my-4">Rap lyrics on SongwriterLink range from narrative storytelling and emotional confessionals to punchline-driven battle verses and radio-ready hooks. Many lyricists focus on modern sub-genres like trap, drill, and melodic rap, giving artists a wide range of styles to choose from.</p>
...
<p class="my-4">Yes. When you purchase lyrics on SongwriterLink, you receive a license from the original lyricist to use those lyrics in your own song. This means you can legally record, release, and perform your song using the purchased lyrics, according to the license terms chosen by the lyricist.</p>
...
<li class="bg-gray-100 p-2 w-fit"><i class="fa-sharp-duotone fa-solid fa-badge-check"></i> Written by real hip-hop lyricists</li>
<li class="bg-gray-200 p-2 w-fit"><i class="fa-sharp-duotone fa-solid fa-badge-check"></i> Designed for verses, hooks, and flows</li>
<li class="bg-gray-100 p-2 w-fit"><i class="fa-sharp-duotone fa-solid fa-badge-check"></i> Works for trap, drill, boom bap, and melodic rap</li>
<li class="bg-gray-200 p-2 w-fit"><i class="fa-sharp-duotone fa-solid fa-badge-check"></i> Faster and cheaper than hiring a ghostwriter</li>
<li class="bg-gray-100 p-2 w-fit"><i class="fa-sharp-duotone fa-solid fa-badge-check"></i> Instant licensing and digital delivery</li>
</ol>


<h3 class="mt-12 text-xl">Browse rap lyrics for sale below and find the perfect lyrics for your next track.</h3>
</div>
...
<div class="gap-4 py-12 justify-around lg:grid grid-cols-3 gap-4 lg:mx-20">
        ...
        <div class="lg:w-2/3 lg:mx-20">
            <button
                onclick="window.location.href='{{ route('buyLyrics', 'genre=Rap') }}'"
