<x-layouts.page :title="__('Buy Reggae Lyrics | Original Reggae Song Lyrics - SongwriterLink')" 
:description="__('Explore original reggae lyrics written by independent songwriters. Ideal for roots, dancehall, and lovers rock — ready to license and record.')"
...
<div class="flex flex-col px-6 text-[#1b1b18] lg:justify-between lg:px-8">
    ...
    <div class="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
        <main class="flex w-full flex-col-reverse overflow-hidden rounded-lg lg:flex-row">
            <div class="p-6 lg:p-0 flex-1 rounded-lg pb-12 text-[13px] leading-[20px] bg-[#ffffff78] bg-gray-50 lg:p-20">
                <h1 class="mb-1 font-medium text-4xl lg:text-6xl">Buy Reggae Lyrics</h1>
            </div>  
        </main>
    </div>

    <div class="lg:w-2/3 lg:mx-20">
        <h2 class="text-2xl mt-8 mb-4">Looking for authentic reggae lyrics that capture rhythm and culture?</h2>

        <p>
            Reggae lyrics bring rhythm, social consciousness, and storytelling together. At SongwriterLink, you can license original reggae lyrics written by independent songwriters specializing in roots reggae, dancehall, lovers rock, and modern reggae. Perfect for solo artists, bands, and producers.
        </p>

        <h3 class="text-lg mt-8 mb-4"><b>How buying reggae lyrics works</b></h3>
        <ol class="list-decimal ml-2 md:flex gap-4">
            <li class="bg-gray-200 mx-2 p-2">Browse lyrics by subgenre or theme</li>
            <li class="bg-gray-100 mx-2 p-2">Preview full verses, choruses, and bridges</li>
            <li class="bg-gray-200 mx-2 p-2">Select a license suitable for recording, streaming, or performance</li>
            <li class="bg-gray-100 mx-2 p-2">Download instantly and start recording</li>
        </ol>

        <p class="my-4">
            Each lyric is crafted to match reggae rhythms, phrasing, and cultural storytelling.
        </p>

        <h3 class="text-lg mt-8 mb-4"><b>Why buy reggae lyrics from SongwriterLink</b></h3>
        <ol class="flex flex-col gap-2">
            <li class="bg-gray-100 p-2 w-fit"><i class="fa-sharp-duotone fa-solid fa-badge-check"></i> Written by authentic reggae songwriters</li>
            <li class="bg-gray-200 p-2 w-fit"><i class="fa-sharp-duotone fa-solid fa-badge-check"></i> Works for roots, dancehall, lovers rock, and modern reggae</li>
            <li class="bg-gray-100 p-2 w-fit"><i class="fa-sharp-duotone fa-solid fa-badge-check"></i> Ready-to-use, affordable, and instantly downloadable</li>
            ...
            <li class="bg-gray-100 p-2 w-fit"><i class="fa-sharp-duotone fa-solid fa-badge-check"></i> Designed for rhythmic phrasing and cultural authenticity</li>
        </ol>

        <h3 class="mt-12 text-xl">Browse reggae lyrics for sale below and find the perfect lyrics for your next recording.</h3>
    </div>
    ...
    <div class="lg:w-2/3 lg:mx-20">
        <button onclick="window.location.href='{{ route('buyLyrics', 'genre=Reggae') }}'" class="rounded-sm bg-[#e8363c] px-5 py-1 my-1 text-lg text-white hover:bg-black cursor-pointer mx-auto w-fit">View More Reggae Lyrics</button>
