<x-layouts.page :title="__('Buy Soul Lyrics | Original Soul Song Lyrics - SongwriterLink')" 
:description="__('Explore original soul lyrics written by independent songwriters. Ideal for R&B, Motown, and heartfelt soul music — ready for licensing and recording.')"
...
<nav class="text-sm text-gray-600 mb-4">
    ...
    <div class="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
        <main class="flex w-full flex-col-reverse overflow-hidden rounded-lg lg:flex-row">
            <div class="p-6 lg:p-0 flex-1 rounded-lg pb-12 text-[13px] leading-[20px] bg-[#ffffff78] bg-gray-50 lg:p-20">
                <h1 class="mb-1 font-medium text-4xl lg:text-6xl">Buy Soul Lyrics</h1>
            </div>  
        </main>
    </div>

    <div class="lg:w-2/3 lg:mx-20">
        <h2 class="text-2xl mt-8 mb-4">Looking for heartfelt, emotional soul lyrics?</h2>

        <p>
            Soul lyrics capture emotion, love, and storytelling in a way that resonates deeply with listeners. At SongwriterLink, you can license original soul lyrics written by independent songwriters specializing in Motown, R&B, and modern soul. Perfect for vocalists, bands, and producers looking for emotional depth in their music.
        </p>

        <h3 class="text-lg mt-8 mb-4"><b>How buying soul lyrics works</b></h3>
        <ol class="list-decimal ml-2 md:flex gap-4">
            <li class="bg-gray-200 mx-2 p-2">Browse lyrics designed to evoke emotion and storytelling</li>
            <li class="bg-gray-100 mx-2 p-2">Preview full verses, choruses, and bridges</li>
            <li class="bg-gray-200 mx-2 p-2">Select a license suitable for recording or performance</li>
            <li class="bg-gray-100 mx-2 p-2">Download instantly and start recording</li>
        </ol>

        <p class="my-4">
            Every lyric is written with passion for soulful expression and vocal performance.
        </p>

        <h3 class="text-lg mt-8 mb-4"><b>Why buy soul lyrics from SongwriterLink</b></h3>
        <ol class="flex flex-col gap-2">
            <li class="bg-gray-100 p-2 w-fit"><i class="fa-sharp-duotone fa-solid fa-badge-check"></i> Written by professional soul songwriters</li>
            <li class="bg-gray-200 p-2 w-fit"><i class="fa-sharp-duotone fa-solid fa-badge-check"></i> Perfect for Motown, R&B, neo-soul, and modern soul styles</li>
            ...
            <li class="bg-gray-100 p-2 w-fit"><i class="fa-sharp-duotone fa-solid fa-badge-check"></i> Designed for strong vocal phrasing and emotive performance</li>
        </ol>

        <h3 class="mt-12 text-xl">Browse soul lyrics for sale below and find the perfect lyrics for your next soulful recording.</h3>
    </div>
    ...
    <div class="lg:w-2/3 lg:mx-20">
        <button onclick="window.location.href='{{ route('buyLyrics', 'genre=Soul') }}'" class="rounded-sm bg-[#e8363c] px-5 py-1 my-1 text-lg text-white hover:bg-black cursor-pointer mx-auto w-fit">View More Soul Lyrics</button>
